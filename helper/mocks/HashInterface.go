...
// CompareHash provides a mock function with given fields: password, hash
func (_m *HashInterface) CompareHash(password string, hash string) bool {
...
func (_m *HashInterface) HashPassword(password string) (string, error) {
